        ...
        <div className="relative z-10">
          ...
          <div className="space-y-6 text-white">
            ...
            <p className="text-lg text-teal-100">
              Join thousands of users who trust VitalCare AI for their healthcare needs.
            </p>
            ...
            <div className="space-y-4 pt-8">
              <div className="flex items-center gap-3">
                ...
                <p className="text-teal-50">Free AI health consultations</p>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center">
                  <span className="text-white">✓</span>
                </div>
                <p className="text-teal-50">Personalized treatment plans</p>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center">
                  <span className="text-white">✓</span>
                </div>
                <p className="text-teal-50">Secure medical records</p>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center">
                  <span className="text-white">✓</span>
                </div>
                <p className="text-teal-50">Doctor recommendations</p>
              </div>
            </div>
          </div>
        </div>
